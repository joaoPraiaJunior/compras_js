...
function checkboxMarcado(labelDoCheckbox) {
    labelDoCheckbox.addEventListener('click', function (evento) {
        const checkbox = evento.currentTarget.querySelector(elementos.inputDoCheckbox);
        const customizado = evento.currentTarget.querySelector(elementos.checkBoxCustomizado);
    });
