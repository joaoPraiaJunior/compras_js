...
function criarItemDaLista(itemDeCompra) {
    ...
    checkboxMarcado(labelDoCheckbo, liDaLista);
...
function alteracaoVisualDoCheckbox(checkbox, checkBoxCustomizado) {
    if (checkbox.checked) {
        checkBoxCustomizado.classList.add('checkbox__customizado--marcado');
    } else {
        checkBoxCustomizado.classList.remove('checkbox__customizado--marcado');
    }
}
